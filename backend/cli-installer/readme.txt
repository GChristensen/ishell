...
3. Use the install_devel.cmd or install_devel.sh script for your OS to install
   the iShell backend application in place.
...
with the backend application installed.

1. Make sure that you have Python 3.7+ installed.
3. Use the install.cmd or install.sh script for your OS to install the
   iShell backend application to the Python local site directory.